		...
		<div class="add_data">
			...
			<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">	
				<div class="box pwd">
					...
					<input type="text" name="expenses" placeholder="Budget Title">
				</div>
				...
				<div class="box pwd">
					...
					<input type="text" name="app" placeholder="Amount">
				</div>
				...
				<div class="back">
					<p>Back to <a id="back" href="maintenance.php">Operating Expenses</a></p>
				</div>
			</form>
		</div>	
	</section>
